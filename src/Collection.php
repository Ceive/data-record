...
namespace Ceive\DataRecord {
    ...
    use Ceive\DataRecord\Collection\Sorter;
	use Ceive\DataRecord\Collection\SorterInterface;
	use Ceive\DataRecord\Schema\Schema;
	use Ceive\DataRecord\Util\Collection\ExtendableInterface;
	use Ceive\DataRecord\Util\Collection\ExtendableTrait;
	use Ceive\DataRecord\Util\Collection\Sortable\SorterInterface as SortableSorterInterface;
	use Ceive\DataRecord\Util\Condition\Condition;
	use Ceive\DataRecord\Util\Condition\ConditionBlock;
	use Ceive\DataRecord\Util\Condition\ConditionComplex;
	use Ceive\DataRecord\Util\Condition\ConditionInterface;
	use Ceive\DataRecord\Util\Registry\RegistryReadInterface;
	...
	class Collection extends
		\Ceive\DataRecord\Util\Collection\Enumeration\Collection
		 ...
		 * @param $destruction
		 * @throws \Ceive\DataRecord\Collection\SynchronizeError
		 * @throws ORMException
		 */
		 ...
		 */
		protected function _appendCondition(ConditionBlock $condition = null, $append = null, $many = false){
			if(!$condition){
