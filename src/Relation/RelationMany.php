 ...
 * Time: 15:59
 */
namespace Ceive\DataRecord\Relation {
	
	use Ceive\DataRecord;
	use Ceive\DataRecord\Snapshot;
	...
	class RelationMany extends RelationSchemaHost{
		...
		public function load(Record $record){
			...
			$relationship = new DataRecord\Relation\Relationship($record, $this, $ancestor );
			return $relationship;
		}
		...
		/**
		 * @param Record $record
		 * @throws DataRecord\ORMException
		 */
