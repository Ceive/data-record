...
namespace Jungle\Data\Storage\Db\Lexer {
	...
	/**
	 * Class SignInterfaceGroup
	 * @package Jungle\Data\Storage\Db\Lexer\Lexer
	 */
	class SignGroup implements SignInterface, NamedInterface{
		...
		/**
		 * @param array|string|SignInterface|SignList $token
		 * @return $this
		 */
