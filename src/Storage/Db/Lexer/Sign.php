...
namespace Jungle\Data\Storage\Db\Lexer {
	 ...
	 */
	class Sign extends Keyword implements SignInterface, NamedInterface{
		 ...
		 * @return false|Token
		 */
		public function recognize(Context $context, $position = 0, $dialect = null, & $nextPoint = null, $contextSource = null){
		 ...
		 */
		public static function getSign(Context $context, $element){
			if(is_string($element)){
				...
				foreach($element as $tName){
					if($tName instanceof SignInterface){
