...
namespace Ceive\DataRecord\Util\Schema\OuterInteraction {
	...
	use Ceive\DataRecord\Util\Schema\OuterInteraction\ValueAccessor\Getter;
	use Ceive\DataRecord\Util\Schema\OuterInteraction\ValueAccessor\GetterInterface;
	use Ceive\DataRecord\Util\Schema\OuterInteraction\ValueAccessor\Setter;
	...
	class ValueAccessor{
		 ...
		 * @param string $key
		 * @param mixed $value
		 * @return \Ceive\DataRecord\Util\Record\PropertyRegistryInterface|mixed
		 */
