 ...
 * Time: 4:06
 */
namespace Ceive\DataRecord\Util\Schema\ValueType {
	
	use Ceive\DataRecord\Util\Schema\ValueType;
	use Ceive\DataRecord\Util\Schema\ValueTypeInterface;
	use Ceive\DataRecord\Util\Validation\Rule\RegExp;
	use Ceive\DataRecord\Util\Validation\Rule\Vartype;
	...
	class ValueTypePool{
		...
		public function vartype($alias, $vartype){
			return $this->types[] = new \Ceive\DataRecord\Util\Schema\ValueType\Vartype($alias, $vartype, [
